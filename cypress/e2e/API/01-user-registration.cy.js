    ...
    it('should find user by Id via API', () => {
        cy.fixture('testData').then((testData) => {
            cy.apiFindUser().then((response) => {
                ...
                expect(response.body._id).to.eq(testData.users.valid._id)
                expect(response.body.nome).to.eq(testData.users.valid.name)
                expect(response.body.email).to.eq(testData.users.valid.email)
